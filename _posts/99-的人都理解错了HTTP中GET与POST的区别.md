...
categories: HTTP
tags: [HTTP, GET, POST]
thumbnail: http://7xveyh.com1.z0.glb.clouddn.com/web-crawling-scraping-ajax-sites-3-638.jpg
---
GET和POST是HTTP请求的两种基本方法，要说它们的区别，接触过WEB开发的人都能说出一二。最直观的区别就是GET把参数包含在URL中，POST通过request body传递参数。<!--more-->
